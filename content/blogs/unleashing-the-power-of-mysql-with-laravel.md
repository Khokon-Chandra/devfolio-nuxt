...
head:
  meta:
    ...
    - property: "og:type"
      content: "article"
    - property: "og:title"
      content: "Unleashing the Power of MySQL with Laravel: A Beginner's Guide to Mastery"
    - property: "og:image"
      content: "https://khokon.vercel.app/blogs/unleashing-the-power-of-mysql-with-laravel.jpg"
    - property: "og:image:alt"
      content: "An image showcasing mysql with laravel."
    - name: "twitter:card"
